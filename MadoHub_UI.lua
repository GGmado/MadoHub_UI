if (game:GetService("CoreGui")):FindFirstChild("MadoHub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).MadoHub:Destroy();
...
ImageButton.Image = "rbxassetid://124073422071742";
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("MadoHub")).Enabled = not (game.CoreGui:FindFirstChild("MadoHub")).Enabled;
end);
...
function Update:Notify(desc)
	...
	Image.Image = "rbxassetid://124073422071742";
	Title.Parent = Frame;
...
function Update:StartLoad()
	...
	TitleLoader.Text = "MadoHub | BloxFruits";
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("MadoHub") then
			makefolder("MadoHub");
		end;
		if not isfolder("MadoHub/Library/") then
			makefolder("MadoHub/Library/");
		end;
		if not isfile(("MadoHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("MadoHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("MadoHub/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("MadoHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("MadoHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local MadoHub = Instance.new("ScreenGui");
	MadoHub.Name = "MadoHub";
	MadoHub.Parent = game.CoreGui;
	MadoHub.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = MadoHub;
